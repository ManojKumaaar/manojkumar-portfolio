...
export class AppComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(): void{
    ...
    this.titleService.setTitle( "Manojkumar| Backend Developer" );

    this.metaService.addTags([
      {name: 'keywords', content: 'Backend, software, developer'},
      {name: 'description', content: 'Portfolio of Manojkumar, a skilled backend developer specializing in building robust and scalable server-side applications.'},
    ]);
